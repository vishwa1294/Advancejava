...
public CustomerDTO(String name, String from, String to, String address, boolean married, int passportNo,EducationType educationType) {
	super();
	this.name = name;
	this.from = from;
	this.to = to;
...
public CustomerDTO(int id, String name, String from, String to, String address, boolean married, int passportNo,EducationType educationType) {
			super();
			this.id = id;
			this.name = name;
			this.from = from;
